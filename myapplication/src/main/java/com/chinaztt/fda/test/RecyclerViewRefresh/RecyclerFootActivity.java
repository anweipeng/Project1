 ...
 * 作者：江清清 on 15/11/22 21:26
 * 邮箱：jiangqqlmj@163.com
 * QQ： 781931404
 * 公司：江苏中天科技软件技术有限公司
 */
public class RecyclerFootActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        demo_swiperefreshlayout.setProgressViewOffset(false, 0, (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 24, getResources()
                        .getDisplayMetrics()));
    ...
    class CustomOnClickListener implements View.OnClickListener{
        ...
        public void onClick(View v) {
            RecyclerFootActivity.this.finish();
        }
    }
}
